...
def parse_energy(rows):
    ...
    # print(f"ascribed_pkg_joules_list before length: {len(ascribed_pkg_joules_list)}")
    # print(f"ascribed_dram_joules_list before length: {len(ascribed_dram_joules_list)}")
    # if len(ascribed_pkg_joules_list) % 2 != 0:
    #     print(f"ascribed_pkg_joules_list len is odd")
    #     # If it's odd, remove the last element
    #     ascribed_pkg_joules_list = ascribed_pkg_joules_list[:-1]
    #     print(f"changed 1: {len(ascribed_pkg_joules_list)}")
    ...
    #     print(f"ascribed_dram_joules_list len is odd")
    #     # If it's odd, remove the last element
    #     ascribed_dram_joules_list = ascribed_dram_joules_list[:-1]
    #     print(f"changed 2: {len(ascribed_dram_joules_list)}")
    ...
    #     print(f"Error: {e}")
    #     print(f"ascribed_pkg_joules_list length: {len(ascribed_pkg_joules_list)}")
    #     print(f"ascribed_dram_joules_list length: {len(ascribed_dram_joules_list)}")
    #     print(f"Energies length: {len(energies)}")
